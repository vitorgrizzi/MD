...
# test_atomic_system({'F': -1, 'Li': 1, 'Na': 1, 'K': 1, 'Cl': -1, 'Mg': 2, 'Be': 2}, 100)
# print(create_atomic_system({'F': -1, 'Li': 1, 'Na': 1, 'K': 1, 'Cl': -1, 'Mg': 2, 'Be': 2}, 100))
# quit()


## Testing the minimum distance between any two atoms considering PBC to check if it respects the 'min_distance'.
# L = 10
# coords = construct_simulation_box(create_atomic_system({'F': -1, 'Li': 1, 'Na': 1, 'K': 1, 'Cl': -1, 'Mg': 2, 'Be': 2}, 100),
...
#     coords = construct_simulation_box(create_atomic_system({'F': -1, 'Li': 1, 'Na': 1, 'K': 1, 'Cl': -1, 'Mg': 2, 'Be': 2}, 100),
#                                         1.6, box_length=L, scale_coords=False, max_tries=20, max_iter=30)
# quit()


## Checking the return from the builder
# atoms = atomic_system_builder({'F': -1, 'Li': 1, 'Na': 1, 'K': 1, 'Cl': -1, 'Mg': 2, 'Be': 2}, 100, 1.5, [8.5,13])
...
# L = 12
# for i in range(N):
#     coords = construct_simulation_box({'F': 37, 'Li': 11, 'Na': 12, 'K': 8, 'Cl': 32, 'Mg': 9, 'Be': 10}, 1.5, box_length=L, scale_coords=False)
